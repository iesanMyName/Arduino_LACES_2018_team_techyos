...
void loop()
{
  ...
  while(1)
  {
    ...
    {     
      ...
      muonFile = SD.open("muonLog.txt",FILE_WRITE);
      if(muonFile)
      {
        muonFile.println((String)count + " " + getDate(time_stamp)+ " " + (String)seconds_stamp.totalseconds()+ " " + avg_adc_measurement+ " " + sipm_voltage + " ");
      }
      else
      {
